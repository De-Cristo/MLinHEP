...
parser.add_argument('--domjj',action='store_true', default=False,help='Setup for mjj plot')
...
parser.add_argument('--region',default='',help='STXS bin')
...
#background_schemes = {
#'Wen':[backgroundComp("Single top",["s_Top"],862),backgroundComp("VV+LF",["VVLF"], 13),backgroundComp("t#bar{t}",["TT"],4),backgroundComp("Z+udsg",["Zj0b_udsg"],402),backgroundComp("Z+c",["Zj0b_c"],397),backgroundComp("Z+b",["Zj1b"],5),backgroundComp("Z+bb",["Zj2b"],807),backgroundComp("W+udsg",["Wj0b_udsg"],814),backgroundComp("W+c",["Wj0b_c"],815),backgroundComp("W+b",["Wj1b","Wj2b"],81),backgroundComp("VV+HF",["VVHF"],17)],#,backgroundComp("ZHb#bar{b}",['ZH_lep_PTV_0_75_hbb','ZH_lep_PTV_75_150_hbb','ZH_lep_PTV_150_250_0J_hbb','ZH_lep_PTV_150_250_GE1J_hbb','ZH_lep_PTV_250_400_hbb','ZH_lep_PTV_GT400_hbb'],2),backgroundComp("WHb#bar{b}",['WH_lep_PTV_0_75_hbb','WH_lep_PTV_75_150_hbb','WH_lep_PTV_150_250_0J_hbb','WH_lep_PTV_150_250_GE1J_hbb','WH_lep_PTV_250_400_hbb','WH_lep_PTV_GT400_hbb'],634)],
#'Wmn':[backgroundComp("Single top",["s_Top"],862),backgroundComp("VV+LF",["VVLF"], 13),backgroundComp("t#bar{t}",["TT"],4),backgroundComp("Z+udsg",["Zj0b_udsg"],402),backgroundComp("Z+c",["Zj0b_c"],397),backgroundComp("Z+b",["Zj1b"],5),backgroundComp("Z+bb",["Zj2b"],807),backgroundComp("W+udsg",["Wj0b_udsg"],814),backgroundComp("W+c",["Wj0b_c"],815),backgroundComp("W+b",["Wj1b","Wj2b"],81),backgroundComp("VV+HF",["VVHF"],17)],#,backgroundComp("ZHb#bar{b}",['ZH_lep_PTV_0_75_hbb','ZH_lep_PTV_75_150_hbb','ZH_lep_PTV_150_250_0J_hbb','ZH_lep_PTV_150_250_GE1J_hbb','ZH_lep_PTV_250_400_hbb','ZH_lep_PTV_GT400_hbb'],2),backgroundComp("WHb#bar{b}",['WH_lep_PTV_0_75_hbb','WH_lep_PTV_75_150_hbb','WH_lep_PTV_150_250_0J_hbb','WH_lep_PTV_150_250_GE1J_hbb','WH_lep_PTV_250_400_hbb','WH_lep_PTV_GT400_hbb'],634)],
if not args.no_signal:
    background_schemes = {
        'Wen':[backgroundComp("t#bar{t}B",["TTB"],862),backgroundComp("t#bar{t}",["TT"],4),backgroundComp("Single top",["s_Top"],402),backgroundComp("TTH",["ttH"],397),backgroundComp("TTV",["TTV"],807)],
        'Wmn':[backgroundComp("t#bar{t}B",["TTB"],862),backgroundComp("t#bar{t}",["TT"],4),backgroundComp("Single top",["s_Top"],402),backgroundComp("TTH",["ttH"],397),backgroundComp("TTV",["TTV"],807)],
        'Znn':[backgroundComp("t#bar{t}B",["TTB"],862),backgroundComp("t#bar{t}",["TT"],4),backgroundComp("Single top",["s_Top"],402),backgroundComp("TTH",["ttH"],397),backgroundComp("TTV",["TTV"],807)],
    }
else:
    background_schemes = { 
        'Wen':[backgroundComp("t#bar{t}B",["TTB"],862),backgroundComp("t#bar{t}",["TT"],4),backgroundComp("Single top",["s_Top"],402),backgroundComp("TTH",["ttH"],397),backgroundComp("TTV",["TTV"],807)],
...
if args.cr:
        background_schemes['Znn']=[backgroundComp("t#bar{t}B",["TTB"],862),backgroundComp("t#bar{t}",["TT"],4),backgroundComp("Single top",["s_Top"],402),backgroundComp("TTH",["ttH"],397),backgroundComp("TTV",["TTV"],807)]
#To be filled later depending on which histograms actually exist
plot_background_schemes = {'Wen':[],'Wmn':[],'Zee':[],'Zmm':[],'Znn':[],'mjj':[]}

#Extract relevant histograms from shape file
print(histo_file,'TotalSig', file_dir, mode, args.no_signal, log_x)
...
splusbhist = getHistogram(histo_file,'TotalBkg',file_dir, mode, logx=log_x)[0]
if args.subbkg!=0:
  splusbhist_total = getHistogram(histo_file,'TotalBkg',file_dir, mode, logx=log_x)[0]
...
if not args.no_signal:
  ...
  if args.subbkg==0:
    legend.AddEntry(sighist,"VHH,HH#rightarrow4b","l")
  else:
    legend.AddEntry(sighist,"VHH,HH#rightarrow4b","f")
  if args.subbkg!=0:
...
setY= setY - 0.04
latex2.DrawLatex(setX,setY,region_label)
...
plot.DrawCMSLogo(pads[0], 'CMS', args.extralabel, 11, 0.045, 0.05, 1.0, '', 0.8)
...
if args.subbkg==0:
  ...
  c2.SaveAs("%(outname)s_unsub.C"%vars())
if args.verbosity>0:
