...
DY_fileDict = {
    "DYToLL_M-50_Inc_madgraph": [
        ["DY", "(sampleIndex/100)==120&&weight>0&&VHH_nBJets==2", 1.458 * 4.229/1394.181 , "DYToLL_M-50_Inc_madgraph"]
    ],
    
    "DYToLL_M-50_HT70to100_madgraph": [
        ["DY", "(sampleIndex/100)==110&&weight>0&&VHH_nBJets==2", 1.458 * 4.229/1394.181 , "DYToLL_M-50_HT70to100_madgraph"]
    ],
    
    "DYToLL_M-50_HT100to200_madgraph": [
        ["DY", "(sampleIndex/100)==111&&weight>0&&VHH_nBJets==2", 1.458 * 4.229/1394.181 , "DYToLL_M-50_HT100to200_madgraph"]
    ], 
    
    "DYToLL_M-50_HT200to400_madgraph": [
        ["DY", "(sampleIndex/100)==112&&weight>0&&VHH_nBJets==2", 1.458 * 4.229/1394.181 , "DYToLL_M-50_HT200to400_madgraph"]
    ],
    
    "DYToLL_M-50_HT400to600_madgraph": [
        ["DY", "(sampleIndex/100)==113&&weight>0&&VHH_nBJets==2", 1.458 * 4.229/1394.181 , "DYToLL_M-50_HT400to600_madgraph"]
    ],
    
    "DYToLL_M-50_HT600to800_madgraph": [
        ["DY", "(sampleIndex/100)==114&&weight>0&&VHH_nBJets==2", 1.458 * 4.229/1394.181 , "DYToLL_M-50_HT600to800_madgraph"]
    ],
    
    "DYToLL_M-50_HT800to1200_madgraph": [
        ["DY", "(sampleIndex/100)==115&&weight>0&&VHH_nBJets==2", 1.458 * 4.229/1394.181 , "DYToLL_M-50_HT800to1200_madgraph"]
    ],
    
    "DYToLL_M-50_HT1200to2500_madgraph": [
        ["DY", "(sampleIndex/100)==116&&weight>0&&VHH_nBJets==2", 1.458 * 4.229/1394.181 , "DYToLL_M-50_HT1200to2500_madgraph"]
    ],
    
    "DYToLL_M-50_HT2500toInf_madgraph": [
        ["DY", "(sampleIndex/100)==117&&weight>0&&VHH_nBJets==2", 1.458 * 4.229/1394.181 , "DYToLL_M-50_HT2500toInf_madgraph"]
    ],
    
    "DYToLL_M10-50_Inc_madgraph": [
        ["DY", "(sampleIndex/100)==119&&weight>0&&VHH_nBJets==2", 1.458 * 4.229/1394.181 , "DYToLL_M10-50_Inc_madgraph"]
    ]
}
...
top_fileDict = {
    ...
    "TT_AllHadronic": [
        ["TT", "sampleIndex==212&&IsttB==0&&weight>0&&VHH_nBJets==2 ", 1.164 * 13.52/3005.955, "TT_AllHadronic"]
    ], 
    "TT_DiLep_NoPSWeights": [
        ["TT", "sampleIndex==202&&IsttB==0&&weight>0&&VHH_nBJets==2 ", 1.164 * 13.52/3005.955, "TT_DiLep_NoPSWeights"]
    ], 
    "TT_SingleLep": [
        ["TT", "sampleIndex==203&&IsttB==0&&weight>0&&VHH_nBJets==2 ", 1.164 * 13.52/3005.955, "TT_SingleLep"]
    ],

    "TTBB_AllHadronic": [
        ["TTB", "sampleIndex==26&&IsttB>0&&weight>0&&VHH_nBJets==2 ", 1.164 * 20.615/94.784, "TTBB_AllHadronic"]
    ], 
    "TTBB_DiLep": [
        ["TTB", "sampleIndex==25&&IsttB>0&&weight>0&&VHH_nBJets==2 ", 1.164 * 20.615/94.784, "TTBB_DiLep"]
    ], 
    "TTBB_SingleLep": [
        ["TTB", "sampleIndex==24&&IsttB>0&&weight>0&&VHH_nBJets==2 ", 1.164 * 20.615/94.784, "TTBB_SingleLep"]
    ],
